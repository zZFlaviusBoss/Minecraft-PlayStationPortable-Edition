...
void Tesselator::addQuadReversed(float u0, float v0, float u1, float v1,
                                 uint32_t c0, uint32_t c1, uint32_t c2,
                                 uint32_t c3, float x0, float y0, float z0,
  ...
  if (l03 > l12) {
    // Reversed winding for (0,2,3) and (0,3,1):
    // (0,3,2) and (0,1,3)
    *v++ = {u0, v0, c0, x0, y0, z0};
    *v++ = {u1, v1, c3, x3, y3, z3};
    *v++ = {u0, v1, c2, x2, y2, z2};
    ...
    *v++ = {u1, v1, c3, x3, y3, z3};
    ...
    // Reversed winding for (0,2,1) and (1,2,3):
    // (0,1,2) and (1,3,2)
    *v++ = {u0, v0, c0, x0, y0, z0};
    *v++ = {u1, v0, c1, x1, y1, z1};
    *v++ = {u0, v1, c2, x2, y2, z2};
